  ...
  return (
    <View style={styles.mainBackground}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.textHeader}>ADD ARTICLE</Text>
        ...
        <View style={{ flex: 6}}>
          <View style={{ position: "absolute", alignSelf: "center" }}>
            ...
            <View style={styles.section}>
              ...
              onFocus={() => { setError("") }} 
              placeholder="Description" placeholderTextColor="gray" style={styles.input} onChangeText={(description) => setDescription(description)} />
            </View>
      ...
      <View style={{ flex: 1,bottom: height / 14, width: "100%" }}>
        ...
        <TouchableOpacity style={styles.btnConfirm} onPress={() => {
          getCurrentDate(); db.addArticle(title, description, selectedValue, completeDate, 
          (error) => { 
            if (error) { setError(er.err2); console.log("error : ", er.err2), Keyboard.dismiss() }
