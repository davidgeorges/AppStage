...
export const printError = (error) => {
  ...
  switch (error.code) {
    case "auth/email-already-in-use":
      err = "Adresse mail déjà utilisé."
      break;
    case "username-already-in-use":
      err = "Nom d'utilisateurdéjà utilisé."
      break;
    case "auth/invalid-email":
      err = "Format d'adresse mail non valide."
      break;
    case "auth/weak-password":
      err = "Mot de passe trop faible."
      break;
    case "auth/too-many-requests":
      err = "Trop de demandes. Réessayez dans une minute."
      break;
    case "auth/user-not-found":
      err = "Utilisateur non trouvé dans notre base de données."
      break;
    case "auth/wrong-password":
      err = "Mauvais mot de passe, veuillez réessayer."
      break;
    default:
      err = "Erreur non définie."
      break;
  }
  alert(err);
}
